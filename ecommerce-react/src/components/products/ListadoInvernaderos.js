...
function ListadoInvernaderos() {
	return(
		<div id="ListadoInvernaderos">
			<div className="bg-gray-200 max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 ">
				<h2 className="mt-1 text-lg font-medium text-gray-900">Invernaderos</h2>
...
export default ListadoInvernaderos;